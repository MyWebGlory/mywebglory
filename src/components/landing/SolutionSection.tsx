...
const SolutionSection = () => {
  ...
  return (
    <section className="py-24 relative overflow-hidden" id="solution">
      ...
      <motion.div 
        className="absolute top-1/4 right-1/4 w-96 h-96 bg-primary/15 rounded-full blur-3xl gpu-accelerated"
        animate={{ 
          scale: [1, 1.3, 1],
          rotate: [0, 90, 0],
        }}
      ...
      />
      <motion.div 
        className="absolute bottom-1/3 left-1/3 w-80 h-80 bg-secondary/10 rounded-full blur-3xl gpu-accelerated"
        animate={{ 
          scale: [1.2, 1, 1.2],
          x: [0, 50, 0],
        }}
