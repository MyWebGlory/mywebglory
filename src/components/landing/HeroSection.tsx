    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 py-14 sm:py-20">
        <div className="container px-4 sm:px-6">
          ...
          {/* Client Logo Slider */}
          {/* Optimized Logo Slider: memoized, CSS-only animation, GPU hint, preloaded images */}
          <div className="w-full pb-2 sm:pb-4">
            ...
            <div className="relative overflow-hidden">
              ...
              <div className="flex items-center will-change-transform" style={{ animation: 'marquee 60s linear infinite', width: 'max-content' }}>
                {[...Array(8)].map((_, i) => (
