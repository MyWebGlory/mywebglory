    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 px-4 md:px-6 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-muted/50 border border-border mb-8 animate-fade-in">
          ...
          <span className="text-sm text-muted-foreground">Event Marketing That Delivers</span>
        </div>
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-fade-in" style={{ animationDelay: "0.2s" }}>
          We build complete marketing systems that turn cold audiences into registered attendees 
          and registered attendees into active participants. From ads to reminders, we handle it all.
        </p>
        ...
        <div className="grid grid-cols-3 gap-8 mt-20 max-w-3xl mx-auto animate-fade-in" style={{ animationDelay: "0.4s" }}>
          {[
            { value: "500+", label: "Events Marketed" },
